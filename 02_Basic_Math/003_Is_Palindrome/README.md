...
## Complexity
- **Time Complexity:** O(log<sub>10</sub>(N)) where N is the input integer. We divide the number by 10 in each iteration of the loop, which means we perform a constant number of operations for each digit.
